...
export default function ProductItem({ id, name, price }) {
	...
	return (
		<div className="cursor-pointer w-6/12 block border mx-auto relative border-stone-200 hover:scale-105 hover:z-10 hover:bg-white">
			...
			<p className="mx-auto mx-1 mt-1" onClick={() => nav("/products/" + id)}>
				{name}
			</p>
